  ...
  if (Platform.OS === 'ios') return <SwiftUIHost key={section === 'data' ? storageLabel : section} modifiers={[tint(theme.blue)]} style={styles.flex}><SwiftUIForm>
    ...
    {section === 'interface' && <>
      <SwiftUISection title="Conversation">
        <NativeToggleRow icon="text.bubble" title="Show prompt suggestions" detail="Show suggested prompts in new chats. Syncs across your devices." value={preferences.showPromptSuggestions} onChange={(value) => setPreference('showPromptSuggestions', value)} />
