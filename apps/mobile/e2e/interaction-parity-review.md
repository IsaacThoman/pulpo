...
![Android rich transcript](evidence/interaction-parity/android-rich.png)
![iOS rich transcript](evidence/interaction-parity/ios-rich.png)
![Android completed queue regression](evidence/interaction-parity/android-queue.png)
![iOS synchronized queue](evidence/interaction-parity/ios-queue.png)
![Android retained offline draft](evidence/interaction-parity/android-offline.png)
![iOS PDF viewer](evidence/interaction-parity/ios-pdf.png)
![iOS image sharing](evidence/interaction-parity/ios-image-share.png)
![Android Agent failure details](evidence/interaction-parity/android-agent-error.png)
![iOS Agent failure details](evidence/interaction-parity/ios-agent-error.png)
