...
const productionPreferenceKeys = new Set(['imageGeneration', 'theme', 'textSize', 'streamResponses', 'showPromptSuggestions', 'showReasoning', 'memoryEnabled', 'haptics', 'sendWithEnter', 'attachmentCacheMb', 'localChatLimit', 'trashRetention', 'automaticChatExpiration', 'newChatAutoExpire']);
