...
const productionPreferenceKeys = new Set(['imageGeneration', 'speech', 'theme', 'textSize', 'streamResponses', 'showPromptSuggestions', 'showReasoning', 'collapseIntermediateMessages', 'memoryEnabled', 'haptics', 'sendWithEnter', 'attachmentCacheMb', 'localChatLimit', 'trashRetention', 'automaticChatExpiration', 'newChatAutoExpire']);
