...
export function AdminWorkspacesPage() {
  ...
  return <div className="space-y-4">
    ...
    <div className="grid grid-cols-2 gap-3 lg:grid-cols-6 [&>*]:min-w-0 [&>*]:wrap-anywhere">
      ...
      <Card className="gap-0 rounded-lg py-0 shadow-none"><div className="overflow-x-auto"><table className="data-table min-w-[1120px]">
        ...
        <tbody>{openWorkspaces.length ? openWorkspaces.map((workspace) => {
          ...
          return <tr key={workspace.id} className="align-top">
            ...
            <td className="max-w-48 px-3 py-2">{workspace.chat ? <div className="truncate">{workspace.response?.modelId ?? ui("Waiting for workspace")}</div> : '—'}</td>
    ...
    <Card className="gap-0 rounded-lg py-0 shadow-none"><div className="overflow-x-auto"><table className="data-table min-w-[1120px]">
      ...
      <tbody>{rows.length ? rows.map((row) => {
        ...
        return <tr key={row.id} className="align-top">
          ...
          <td className="max-w-48 px-3 py-2"><div className="truncate">{row.response.modelId ?? ui("Waiting for workspace")}</div></td>
