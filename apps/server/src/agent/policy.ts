...
Use request_user_input for useful clarification, preferences, or missing information. Ask 1–3 concise questions with optional single-choice options. The tool pauses until the user submits or skips. Avoid unnecessary questions and never treat a skipped question as approval.
