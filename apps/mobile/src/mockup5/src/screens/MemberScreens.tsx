  ...
  if (Platform.OS === 'ios') return <SwiftUIHost key={section === 'data' ? storageLabel : section} modifiers={[tint(theme.blue)]} style={styles.flex}><SwiftUIForm>
    ...
    {section === 'interface' && <>
      <SwiftUISection title="Conversation">
        ...
        <NativeToggleRow icon="exclamationmark.bubble" title="Show model warnings" detail="Show notes from your administrator about the selected model." value={preferences.showModelWarnings} onChange={(value) => setPreference('showModelWarnings', value)} />
