...
describe('polar dashboard urls', () => {
  it('uses the sandbox host and /to/dashboard redirects', () => {
    ...
    expect(polarOrderUrl('sandbox', 'ord_1')).toBe('https://sandbox.polar.sh/to/dashboard/sales/orders/ord_1')
  ...
  it('uses the production host', () => {
    expect(polarDashboardUrl('production', '/sales/orders/ord_1')).toBe('https://polar.sh/to/dashboard/sales/orders/ord_1')
  })
})
