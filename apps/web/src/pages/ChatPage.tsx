          ...
          {suggestions.map((s, i) => (
            <button
              ...
              className={cn(
                ...
                showTemporaryLabel && 'border-dashed !border-violet-500/50 bg-violet-100/80 hover:bg-violet-200/80 dark:!border-violet-600/50 dark:bg-violet-950/60 dark:hover:bg-violet-900/60',
              )}
            >
              {s.label}
            </button>
