...
export function UsageCostBreakdown({
  ...
  const accessibleBreakdown = uit`${formattedCombined} · ${ui("API equivalent")}: ${formattedReference} · ${ui("Pulpo charge")}: ${formattedPulpoCost}${coverageLabel ? ` · ${coverageLabel}` : ''}`
