...
export type MenuProps = { disabled?: boolean; label: string; icon: string; actions?: Action[]; sections?: MenuSection[]; text?: string; compact?: boolean; image?: ImageSourcePropType; centered?: boolean };
