...
function ThemeImageTile({ mode, model }: { mode: 'light' | 'dark'; model: Model }) {
  const isCurrent =
    mode === 'dark'
      ...
      <DialogContent className="h-[640px] max-h-[88vh] gap-0 overflow-hidden p-0 sm:max-w-2xl">
        ...
        <ScrollArea className="min-h-0 flex-1">
          <div className="space-y-5 px-6 py-5">
            {/* deathgrips light/dark profile image grid */}
            <div className="grid grid-cols-2 gap-4">
              <ThemeImageTile mode="light" model={model} />
              <ThemeImageTile mode="dark" model={model} />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Input placeholder="alloy" className="w-48" />
            </div>
