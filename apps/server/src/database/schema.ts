...
export const providerConnections = pgTable('provider_connections', {
  ...
  cacheAffinityMode: text('cache_affinity_mode').notNull().default('none'),
...
export const models = pgTable('models', {
  ...
  promptCaching: text('prompt_caching').$type<import('@pulpo/contracts').ModelPromptCaching>().notNull().default('auto'),
...
export const modelPricingVersions = pgTable('model_pricing_versions', {
  ...
  cacheWritePriceMicros: bigint('cache_write_price_micros', { mode: 'number' }).notNull(),
