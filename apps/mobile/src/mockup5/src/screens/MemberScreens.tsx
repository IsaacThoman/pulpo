  ...
  if (Platform.OS === 'ios') return <SwiftUIHost key={section === 'data' ? storageLabel : section} modifiers={[tint(theme.blue)]} style={styles.flex}><SwiftUIForm>
    ...
    {section === 'data' && <>
      <SwiftUISection title="Memories">
        <NativeToggleRow icon="brain.head.profile" title="Memories" detail="Save durable facts and recall relevant context from eligible chats." value={preferences.memoryEnabled} onChange={(value) => setPreference('memoryEnabled', value)} />
      </SwiftUISection>
