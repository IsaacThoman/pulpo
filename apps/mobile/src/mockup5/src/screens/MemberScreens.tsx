...
const settingTitles: Record<SettingsSection, string> = { imageGeneration: 'Image generation', speech: 'Speech', general: 'General', interface: 'Interface', data: 'Data Controls' };
