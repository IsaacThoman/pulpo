            ...
            <div className="p-4 sm:p-6">
              ...
              {section === 'interface' && (
                <div>
                  ...
                  <Row label={ui("Sync drafts across devices")} hint={ui("Keep non-temporary unsent messages, attachments, and composer choices available on your signed-in devices. Turning this off removes server copies but keeps local drafts.")}>
