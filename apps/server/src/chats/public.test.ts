...
describe('public chat DTOs', () => {
  it('only exposes client-supported chat fields', () => {
    const row = {
      id: '00000000-0000-4000-8000-000000000001', userId: 'private-user', profileId: 'private-profile', folderId: null,
  ...
  it('does not expose internal response persistence fields', () => {
    const row = {
      ...
      chatId: '00000000-0000-4000-8000-000000000001', userId: 'private-user', profileId: 'private-profile',
