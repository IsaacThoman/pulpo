...
describe('subscription coverage cost', () => {
  ...
  it('renders the original cost as an accessible full-coverage tooltip trigger', () => {
    ...
    expect(markup).not.toContain('decoration-')
  ...
  it('colors partial coverage without underlining and leaves uncovered cost unstyled', () => {
    ...
    expect(partial).not.toContain('underline')
    expect(partial).not.toContain('decoration-')
    ...
    expect(uncovered).not.toContain('underline')
  })
})
