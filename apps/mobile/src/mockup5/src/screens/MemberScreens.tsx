  ...
  if (Platform.OS === 'ios') return <SwiftUIHost key={section === 'data' ? storageLabel : section} modifiers={[tint(theme.blue)]} style={styles.flex}><SwiftUIForm>
    ...
    {section === 'interface' && <>
      <SwiftUISection title="Conversation">
        ...
        <NativeToggleRow icon="arrow.triangle.2.circlepath" title="Sync drafts" detail="Keep non-temporary unsent messages and files available on your signed-in devices." value={preferences.syncDrafts} onChange={(value) => setPreference('syncDrafts', value)} />
      </SwiftUISection>
