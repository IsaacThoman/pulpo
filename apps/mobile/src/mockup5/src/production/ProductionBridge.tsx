    ...
    usePrototypeStore.setState((state) => {
      ...
      return {
        ...
        preferences: {
          ...
          showPromptSuggestions: preferences.showPromptSuggestions,
          showModelWarnings: preferences.showModelWarnings,
          modelWarningDismissals: preferences.modelWarningDismissals,
...
export function ProductionBridge({ activeChatId }: { activeChatId: string | null }) {
  ...
  const preferences = usePreferencesStore(useShallow((state) => ({
    ...
    showModelWarnings: state.showModelWarnings,
    modelWarningDismissals: state.modelWarningDismissals,
